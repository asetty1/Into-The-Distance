class Game extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.text(game.config.width / 2, game.config.height / 2 - 128, `Your Score: ${gameScores.currentScore}`, scoreConfig).setOrigin(0.5)
        this.add.text(game.config.width / 2, game.config.height / 2 - 64, `High Score: ${gameScores.highScore}`, scoreConfig).setOrigin(0.5)
